import { deriveEncryptionKey, encryptECDH, USER_KEY_PREFIX, decryptECDH, } from './encryption.js';
 ...
 */
export function encryptDataFieldWithPublicKey(nodePublicKey, data, userEncryptionKey) {
    ...
    // Encrypt data
    const encryptionResult = encryptECDH(encryptionPrivateKey, hexToU8a(nodePublicKey), dataEncoded);
 ...
 */
export function decryptNodeResponseWithPublicKey(nodePublicKey, encryptedResponse, encryptionKey) {
    // Create encryption key using KDF
    ...
    const decryptionResult = decryptECDH(encryptionPrivateKey, hexToU8a(nodePublicKey), responseEncoded);
